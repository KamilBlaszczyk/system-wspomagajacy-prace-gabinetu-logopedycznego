...
$options['db.user'] = 'yellowis_rex2';
$options['db.pw'] = 'GL8xULlY';
$options['db.name'] = 'yellowis_rex2';
// -----------------------------------------------------------------------------
// Main
// -----------------------------------------------------------------------------
// check performance
...
function test_loops(&$result, $count = 9999999)
{
    $timeStart = microtime(true);
    for ($i = 0; $i < $count; ++$i) {
...
function test_ifelse(&$result, $count = 9999999)
{
    $timeStart = microtime(true);
    for ($i = 0; $i < $count; $i++) {
        if ($i == -1) {
